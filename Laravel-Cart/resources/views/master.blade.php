...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Kyah Shopping Cart')</title>
    <meta name="description" content="Kyah Shopping Cart">
...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{ url('/') }}">Kyah Shopping Cart</a>
            </div>
    ...
    <footer>
      <div class="container">
        <p class="text-muted">By <a href="http://andremadarang.com">Aldrin Pineda</a></p>
      </div>
    </footer>
